...
const CommonFooter = () => {
  return (
    <>
      <div className="row main-footer hidden-m">
      ...
      <div className="main-footer hidden-pc">
        <p style={{ fontSize: 10 }}>
          kartsfinearts2021.com <br /> betannyeong.online@gmail.com
        </p>

        <div style={{ fontSize: 10 }} tabIndex="0">
